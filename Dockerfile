...
##   $ docker build -t python-for-sebgoa-hostname .
##
## RUNNING
##   $ docker run python-for-sebgoa-hostname

FROM gcr.io/stacksmith-images/minideb:jessie-r8

MAINTAINER Bitnami <containers@bitnami.com>

ENV STACKSMITH_STACK_ID="f8rfyji" \
    STACKSMITH_STACK_NAME="Python for sebgoa/hostname" \
